...
export class RegistrationPaymentHistoryService {
  create(createRegistrationPaymentHistoryInput: CreateRegistrationPaymentHistoryInput) {
  ...
  update(id: number, updateRegistrationPaymentHistoryInput: UpdateRegistrationPaymentHistoryInput) {
